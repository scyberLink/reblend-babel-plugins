...
import plugin from 'babel-plugin-transform-reblend-jsx/lib/development';
...
export default plugin as typeof import('babel-plugin-transform-reblend-jsx').default;
