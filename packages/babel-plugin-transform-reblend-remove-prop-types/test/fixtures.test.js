...
import babelPluginTransformReblendRemovePropTypes from '../src/index'
            ...
            case 'remove-es5':
              babelConfig = {
                plugins: [
                  ...
                  [
                    babelPluginTransformReblendRemovePropTypes,
                    {
                      ...options,
                      mode: 'remove',
                    },
            ...
            default:
              babelConfig = {
                plugins: [
                  babelPluginExternalHelpers,
                  babelPluginProposalObjectRestSpread,
                  [babelPluginTransformReblendRemovePropTypes, options],
                ],
              }
          }
