...
const normalize_options_ts_1 = __importDefault(require("./normalize-options.ts"));
exports.default = (0, helper_plugin_utils_1.declarePreset)((api, opts) => {
    api.assertVersion(REQUIRED_VERSION(7));
    const { development, importSource, pragma, pragmaFrag, pure, runtime, throwIfNamespace, } = (0, normalize_options_ts_1.default)(opts);
    return {
        plugins: [
            [
